...
export const updatePromotion = createAsyncThunk("promotionsApp/promotion/updatePromotion", async (promotionData, { dispatch, getState }) => {
  /* const response = await axios.put(BASE_URL + API_VERSION3 + "/back/coupons", promotionData, { headers: { Authorization: TOKEN } });
  const data = await response.data;
  return data; */
});
