      ...
      >
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <MenuItem value='text'>Pregunta y respuesta</MenuItem>
            <MenuItem value='multiple'>Pregunta de opciones multiples</MenuItem>
            <MenuItem value='option'>Pregunta de opcion unica</MenuItem>
          </Select>
        </Grid>
      </Grid>
      <Grid
