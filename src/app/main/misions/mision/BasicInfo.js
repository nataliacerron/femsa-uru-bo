...
function BasicInfo(props) {
  ...
  useEffect(() => {
    ...
    if (year && !yearss.includes(year)) {
      setYears([year, ...yearss]);
    } else {
      setYears(yearss);
    }
  ...
  /*const changeSelectImg = async (e) => {
    ...
    try {
      switch (e) {
        case 1:
          await listAllByFolderMission("images/logos_con_fondo", setData);
          break;
        case 2:
          await listAllByFolderMission("images/logos_sin_fondo", setData);
          break;
        case 3:
          await listAllByFolderMission("images/empaques", setData);
          break;
      ...
      >
        ...
        <Grid item xs={12}>
          <Select
            ...
            variant="outlined"
            fullWidth
            onChange={(e) => { setLoading(true); changeSelectImg(e.target.value); }}
            defaultValue={-1}
          >
